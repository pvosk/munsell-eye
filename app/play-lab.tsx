...
export function PlayLabPanel({sync,current,onReplay,onReveal}:{sync:ReturnType<typeof usePlayLabSync>;current:LabAttempt|null;onReplay:(specimen:LabSpecimen)=>void;onReveal:()=>void}) {
  ...
  return <section className="play-lab-panel" aria-label="Hole design lab">
    ...
    {!sync.signedIn?<p><a href="/signin-with-chatgpt?return_to=%2F%3Fmode%3Dplay%26lab%3D1" target="_top">Sign in with ChatGPT</a> to save private attempts and notes across devices.</p>:<>
      ...
      <p className="lab-muted">Round 9: five contrasting journeys. Teal Ember is the known-good reference; CMY appears twice to compare a warm chromatic ride with a darker value shift. Sienna Field tests a muted triad, and Maroon Arc tests a three-start ride opportunity. Choose your base freely and compare the sense of travel, setup, and finish. Par, controls, and landing tolerance are unchanged. Earlier rounds and reviews remain available.</p>
