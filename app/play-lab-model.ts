...
export type LabReview = { verdict: string; challenge: string; issue: string; note: string; shot: number | null; routeVerdict?:string; comparison?:string; paletteVerdict?:string };
