...
87 existing paint snapshots; 768 four/five-paint palettes; 25,535 backward proposals; 2111 palette/target requests not supported by the feasibility search; 208 shorter-route screens; 46 deep audits; 17 fixed/joint refinement results.
...
23 baseline audits have a shortest-found three-leg solution; 0 have a shortest-found four-leg solution. After refinement: 8 three-leg and 0 four-leg results. Repeated parents/arms are not independent discoveries or unique palettes.

16 refinement results accepted at least one optimization step. Improvements in the objective are not evidence of better player experience. No global absence-of-shortcut proof is claimed.

## Diverse replayable candidates

| Request | Paints | Shortest found legs | Shorter miss / tolerance | Style evidence |
|---|---|---:|---:|---|
| light-rise | Chartreuse / Permanent Rose / Flake White Replacement / Ivory Black | 3 | 1.65 | Available on efficient routes |
| dark-drop | Cobalt Blue / Cadmium Orange / Quinacridone Magenta / Flake White | 3 | 2.80 | Requested style not found on efficient routes |
| mid-balance | Permanent Rose / Flake White Replacement / Chartreuse / Cerulean Blue | 3 | 2.79 | Available on efficient routes |
| fixed-hansa | Cadmium Orange / Dioxazine Purple / Phthalo Green (Yellow Shade) / Titanium White | 3 | 2.03 | Available on efficient routes |
| fixed-ryb | Flake White Replacement / Cerulean Blue / Bismuth Yellow / Indian Red | 3 | 1.90 | Available on efficient routes |
...
Run scripts/search-conditioned-branches.ts with a fresh CONDITION_OUTPUT; defaults: seed 1031931, palettes 768, eight inverse starts per feasible target, five audits per paint-count/target group. Then run scripts/assess-conditioned-branches.ts. The manifest retains palette snapshots and target specifications. Large exact banks use verified gzip parts through scripts/research-bank-io.ts.
